...
//Attempting list entries, not working
	/*for (i = 0; i < countries.length; i++) {
		listItem = document.createElement("li");
		listItem.appendChild(countries[i]);
		listOrdered.appendChild(listItem);
	}*/
	/*const btn = document.querySelector('button');*/


	//Creates ordered list of countries
/*function createList() {
	var countries = [];
    iterator = 0;
    for (i = 0; i < 25; i++) {
	...
	for (i = 0; i < countries.length; i++) {
		list = document.createItem("li");
		list.appendChild(countries[i]);
	...
	/*<ol>
	for (i = 0; i < countrues.length; i++) {
		<li>listMaker(countries[i])</li>
	}
		listMaker()
	</ol>*/
/*
	var countryListFinal = "<ol>";
    for (i = 0; i < countries.length; i++) {
        countryListFinal += "<li>" + countries[i] + "</li>";
	}
	countryListFinal += "</ol>";
	list1.innerText = countryListFinal;
	paragraphs.appendChild(list1)*/
/*
